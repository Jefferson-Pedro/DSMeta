<h1> 💬 DSMeta</h1>
<p> O projeto desenvolvido durante a semana do Spring React ⚡</p>
...
✔️ A aplicação deve permitir enviar um sms para o administrador com o dado da linha filtrada <br>
✔️ A aplicação deve permitir filtrar as vendas por data <br>
